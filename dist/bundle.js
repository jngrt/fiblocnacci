...
var _GridModel = __webpack_require__(4);

var _GridModel2 = _interopRequireDefault(_GridModel);

var _GridView = __webpack_require__(5);
...
var model = new _GridModel2.default(SIZE, function (data, row, col, seq) {
  if (view) view.update(data, row, col, seq);
});

var view = new _GridView2.default(SIZE, function (row, col) {
...
var GridModel = function () {
  function GridModel(size, changeCallback) {
  ...
  _createClass(GridModel, [{
    ...
    key: 'activateCell',
    value: function activateCell(row, col) {
      this.grid[row].forEach(function (val, i, data) {
        return data[i]++;
      });
      this.grid.forEach(function (val, i, data) {
        return data[i][col]++;
      });
      this.grid[row][col]--;
      ...
      if (this.changeCallback) this.changeCallback(this.getData(), row, col, this.sequences);
    }
  }, {
    key: 'toString',
    value: function toString() {
      return this.grid.map(function (ar) {
        return ar.join(', ');
      }).join('\n');
    }
  }, {
    ...
    key: 'clearSequences',
    value: function clearSequences() {
      var _this2 = this;

      this.sequences.forEach(function (seq) {
        seq.forEach(function (cell) {
          return _this2.grid[cell.r][cell.c] = 0;
        });
      });
    }
    ...
    value: function findRowRight() {
      ...
      this.findSeqIter({
        nextLine: function nextLine() {
          c = -1;
          return ++r < _this3.size;
        },
        nextCell: function nextCell() {
          return ++c < _this3.size;
        },
        getVal: function getVal() {
          return _this3.grid[r][c];
        },
        getData: function getData() {
          return { r: r, c: c, val: _this3.grid[r][c] };
        },
    ...
    value: function findRowLeft() {
      ...
      this.findSeqIter({
        nextLine: function nextLine() {
          c = _this4.size;
          return ++r < _this4.size;
        },
        nextCell: function nextCell() {
          return --c >= 0;
        },
        getVal: function getVal() {
          return _this4.grid[r][c];
        },
        getData: function getData() {
          return { r: r, c: c, val: _this4.grid[r][c] };
        },
        toString: function toString() {
          return r + ' - ' + c;
        }
    ...
    value: function findColDown() {
      ...
      this.findSeqIter({
        nextLine: function nextLine() {
          r = -1;
          return ++c < _this5.size;
        },
        nextCell: function nextCell() {
          return ++r < _this5.size;
        },
        getVal: function getVal() {
          return _this5.grid[r][c];
        },
        getData: function getData() {
          return { r: r, c: c, val: _this5.grid[r][c] };
        },
        toString: function toString() {
          return r + ' - ' + c;
        }
    ...
    value: function findColUp() {
      ...
      this.findSeqIter({
        nextLine: function nextLine() {
          r = _this6.size;
          return ++c < _this6.size;
        },
        nextCell: function nextCell() {
          return --r >= 0;
        },
        getVal: function getVal() {
          return _this6.grid[r][c];
        },
        getData: function getData() {
          return { r: r, c: c, val: _this6.grid[r][c] };
        },
        toString: function toString() {
          return r + ' - ' + c;
        }
    ...
    key: 'findSeqIter',
    value: function findSeqIter(iter) {
    ...
    value: function filterOnes(ar) {
      ...
      var last = ar.findIndex(function (el) {
        return el.val === 1;
      });
    ...
    key: 'fitInSequence',
    value: function fitInSequence(val) {
      //first one in sequence always fits
      if (!this.current.length) return true;

      //check if previous one and new one are 1's
      var last = this.current[this.current.length - 1].val;
      if (val === 1 && last === 1) return true;
    ...
    value: function generateFibonacci(max) {
      if (!this.memory) {
        this.memory = [1, 1];
      }
      var mem = this.memory;
...
var GridView = function () {
  function GridView(size, clickCallback) {
  ...
  _createClass(GridView, [{
    ...
    value: function initGrid(size) {
      ...
      var htmlStr = '';
      _(this.size).times(function (row) {
        htmlStr += '<div class="row">';

        _(_this.size).times(function (col) {
    ...
    key: 'update',
    value: function update(data, row, col, sequences) {
      var _this2 = this;

      //Update all numbers
      data.forEach(function (rowAr, r) {
        rowAr.forEach(function (cell, c) {
      ...
      sequences.forEach(function (seq) {
        seq.forEach(function (cell) {
          _this2.animGreen(cell.r, cell.c);
        });
      });
    ...
    key: 'clearAnims',
    value: function clearAnims() {
      document.querySelectorAll('.activated, .sequence').forEach(function (el) {
    ...
    value: function addClickHandler() {
      ...
      document.querySelector('body').addEventListener('click', function (e) {
        ...
        var col = ~~(e.x / (window.innerWidth / _this3.size));
        var row = ~~(e.y / (window.innerHeight / _this3.size));

        //highlight the clicked cell
        _this3.animYellow(row, col, 'activated');
        _this3.setAnimTimeout();

        // pass the event to the model
        if (self.clickCallback) self.clickCallback(row, col);
      });
    }
  }, {
    key: 'animGreen',
    value: function animGreen(row, col) {
      var el = document.querySelector('.r' + row + '.c' + col + '>div>div');
      el.classList.add('sequence');
    }
  }, {
    key: 'animYellow',
    value: function animYellow(row, col) {

      var el = document.querySelector('.r' + row + '.c' + col + '>div');
